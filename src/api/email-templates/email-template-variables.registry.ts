...
export const ALWAYS_AVAILABLE_EMAIL_TEMPLATE_VARIABLES: AvailableEmailTemplateEntityDto[] = [
  {
    entity: 'tenant',
    label: 'Tenant',
    moduleCode: 'tenant',
...
export const EMAIL_TEMPLATE_VARIABLE_REGISTRY: AvailableEmailTemplateEntityDto[] = [
  {
    entity: 'customer',
    label: 'Cliente',
