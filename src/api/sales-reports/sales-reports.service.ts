...
export class SalesReportsService {
  ...
  async getSalesBySellerReport(
    ...
    const qb = this.salesOrderRepo
      ...
      .addSelect('seller.first_name', 'seller_first_name')
      .addSelect('seller.last_name', 'seller_last_name')
    ...
    qb
      ...
      .addGroupBy('seller.first_name')
      .addGroupBy('seller.last_name')
