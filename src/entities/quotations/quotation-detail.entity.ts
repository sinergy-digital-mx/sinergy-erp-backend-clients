...
@Entity('inv_s_quotation_details')
@Index('idx_qt_detail_quotation', ['quotation_id'])
@Index('idx_qt_detail_product', ['product_id'])
export class QuotationDetail {
  @PrimaryGeneratedColumn('uuid')
  id: string;

  @ManyToOne(() => Quotation, (quotation) => quotation.line_items, {
    onDelete: 'CASCADE',
    nullable: false,
  })
  ...
  /** Precio unitario capturado (POS o manual). Hasta 4 decimales. No se recalcula al convertir. */
