...
export declare class SelfInvoiceService {
    private readonly salesOrderRepo;
    private readonly customerRepo;
    private readonly customerStatusRepo;
    private readonly electronicInvoiceService;
    private readonly configService;
    private readonly logger;
    constructor(salesOrderRepo: Repository<SalesOrder>, customerRepo: Repository<Customer>, customerStatusRepo: Repository<CustomerStatus>, electronicInvoiceService: ElectronicInvoiceService, configService: ConfigService);
    getReceipt(rawCode: string): Promise<{
        code: string | null;
    ...
    identify(rawCode: string, dto: IdentifySelfInvoiceDto): Promise<{
        matched: boolean;
        code: string | null;
        total: number;
        currency: string;
    ...
    stamp(rawCode: string, dto: StampSelfInvoiceDto): Promise<{
        code: string | null;
        uuid: string | null;
    ...
    getInvoiceXml(rawCode: string): Promise<{
        xml: string;
        fileName: string;
    }>;
    getInvoicePdf(rawCode: string): Promise<import("../electronic-invoicing/services/electronic-invoice-pdf.service").ElectronicInvoicePdfUploadResult>;
    private getOrderByPublicCode;
    private assertInvoiceable;
    private findCurrentInvoice;
    private resolveBranch;
    private findMatchingCustomer;
    private contactsMatch;
    private hasRealRfc;
    private toFiscalPayload;
    private suggestRegimen;
    private persistReceptor;
    private isGenericCustomer;
    private folioFromPublicCode;
    private stampEnvironment;
}
