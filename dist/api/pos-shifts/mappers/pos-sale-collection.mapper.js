...
function formatCustomerDisplayName(customer) {
    ...
    if (fullName)
        return fullName;
    if (customer.fiscal_razon_social?.trim())
        return customer.fiscal_razon_social.trim();
    return null;
}
function mapPosCustomer(customer) {
    if (!customer)
        return null;
    return {
        id: customer.id,
...
function mapPosSaleCollection(collection) {
    return {
        id: collection.id,
...
//# sourceMappingURL=pos-sale-collection.mapper.js.map