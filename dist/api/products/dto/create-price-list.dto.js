...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Precio Comercial', description: 'Nombre de la lista de precios' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Precios para clientes comerciales', description: 'Descripción' }),
