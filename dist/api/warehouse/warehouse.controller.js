...
const query_warehouse_dto_1 = require("./dto/query-warehouse.dto");
...
__decorate([
    (0, common_1.Post)(),
    (0, require_permissions_decorator_1.RequirePermissions)({ entityType: 'Warehouse', action: 'Create' }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new warehouse' }),
    (0, swagger_1.ApiBody)({ type: create_warehouse_dto_1.CreateWarehouseDto }),
...
__decorate([
    (0, common_1.Get)(),
    (0, require_permissions_decorator_1.RequirePermissions)({ entityType: 'Warehouse', action: 'Read' }),
    (0, swagger_1.ApiOperation)({ summary: 'Get paginated warehouses with search and filters' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of warehouses retrieved successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden' }),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_warehouse_dto_1.QueryWarehouseDto, Object]),
    __metadata("design:returntype", Promise)
], WarehouseController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, require_permissions_decorator_1.RequirePermissions)({ entityType: 'Warehouse', action: 'Read' }),
    (0, swagger_1.ApiOperation)({ summary: 'Get a specific warehouse by ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: 'string', description: 'Warehouse ID' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, require_permissions_decorator_1.RequirePermissions)({ entityType: 'Warehouse', action: 'Update' }),
    (0, swagger_1.ApiOperation)({ summary: 'Update an existing warehouse' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: 'string' }),
    (0, swagger_1.ApiBody)({ type: update_warehouse_dto_1.UpdateWarehouseDto }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_warehouse_dto_1.UpdateWarehouseDto, Object]),
    __metadata("design:returntype", void 0)
], WarehouseController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(200),
    (0, require_permissions_decorator_1.RequirePermissions)({ entityType: 'Warehouse', action: 'Delete' }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a warehouse by ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: 'string' }),
...
exports.WarehouseController = WarehouseController = __decorate([
    ...
    (0, common_1.Controller)('tenant/warehouses'),
