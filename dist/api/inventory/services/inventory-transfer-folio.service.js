...
exports.InventoryTransferFolioService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const inventory_transfer_entity_1 = require("../../../entities/inventory/inventory-transfer.entity");
let InventoryTransferFolioService = class InventoryTransferFolioService {
    transferRepo;
    ...
    async generateFolio(tenantId) {
        const result = await this.transferRepo
            ...
            .select("MAX(CAST(SUBSTRING_INDEX(transfer.folio, '-', -1) AS UNSIGNED))", 'maxSeq')
...
exports.InventoryTransferFolioService = InventoryTransferFolioService;
exports.InventoryTransferFolioService = InventoryTransferFolioService = __decorate([
...
//# sourceMappingURL=inventory-transfer-folio.service.js.map